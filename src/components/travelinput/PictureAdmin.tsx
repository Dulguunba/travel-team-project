...
export const PictureAdmin = () => {
  ...
  return (
    <div  className={` ${page==4 ? 'flex' : 'hidden'}  w-full h-full min-h-screen gap-7  flex-col justify-start items-start`}>
      ...
      >
        ...
        <div className="w-1/2 text-sm h-96 flex-col mb-2 gap-1">
              <label htmlFor="additionalInfo">Аялалын дэлгэрэнгүй мэдээлэл</label>
              <textarea
                id="additionalInfo"
          ...
          <div className="w-1/2 flex flex-col gap-4">
              ...
              <div className="bg-gray-100 border-dashed border-2 border-gray-300 h-36 rounded-lg w-full relative">
                ...
                >
                  <p className="font-semibold">
                    {mainImage ? "Change image for the travel" : "Add image for the travel"}
                  </p>
                  <div className="w-1/2 relative h-8">
                    ...
                    <input
                      ...
                      onChange={(e) => uploadImage(e, setMainImage, setMainLoading)}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="w-full h-40 text-sm flex-col">
              ...
              <div className="bg-gray-100 border-dashed border-2 border-gray-300 h-36 rounded-lg w-full relative">
                ...
                >
                  <p className="font-semibold">
                    {supportImage ? "Change image for the travel" : "Add image for the travel"}
                  </p>
                  <div className="w-1/2 relative h-8">
                    <button className="bg-black w-full h-full absolute top-0 left-0 text-white p-2 rounded">
                    ...
                    <input
                      ...
                      className="h-full  w-full absolute top-0 left-0 opacity-0"
                      accept="image/jpeg, image/png, image/jpg"
                      onChange={(e) => uploadImage(e, setSupportImage, setSupportLoading)}
                    />
                  </div>
                </div>
              </div>
