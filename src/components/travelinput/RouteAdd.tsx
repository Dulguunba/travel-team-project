...
export const RouteAdd = () => {
    ...
    const { travelRoutesZustand, updateTravelRouteZustand } = useTravelRouteStore()
    ...
    const uploadImage = async (e: React.ChangeEvent<HTMLInputElement>, setUrl: Function, setLoad: Function) => {
        setLoad(true);
        const config = {
            headers: {
    ...
    return (
        <form className='w-full flex flex-col gap-2 bg-gray-50 p-2 rounded-lg' onSubmit={formik.handleSubmit}>
                ...
                <div className='w-1/2 flex flex-col gap-1'>
                    ...
                    <div className="w-full h-12 text-sm flex-col mb-2 gap-1">
                        ...
                        <div className="bg-gray-100 border-dashed border-2 border-gray-300 h-12 rounded-lg w-full relative">
                            ...
                            />
                            <div
                                className={`absolute top-[40%] left-[40%]  gap-5 text-lg ${loading ? "flex" : "hidden"
                                    } `}
                            >
                                <span>Loading</span>
                            ...
                            <div
                                className={`w-full  h-full absolute top-0 left-0 flex flex-col items-center gap-2 justify-center ${loading ? "hidden" : "flex"
                                    }`}
                            >
                                <div className="w-1/2 relative h-8">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => uploadImage(e, setTravelPointImage, setLoading)}
                                    />
                                </div>
                            </div>
                        </div>
            ...
            <button type='submit' className='w-full rounded-lg bg-primary text-white font-medium p-2'>Add</button>
        </form>
    )
}
