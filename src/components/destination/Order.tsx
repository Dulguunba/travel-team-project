...
import { Correct, Wrong, LocationBlue, TimeBlue, DollarBlue, Human } from '../icons/destination';
            ...
            <div className='md:flex max-w-[1520px] w-[90%] py-5 md:justify-between'>
                ...
                <div id='order' className='rounded-[25px] p-12 max-w-[581px] flex flex-col gap-6'>
                    ...
                    <div className='bg-grayColor rounded-xl'>
                        <input onChange={(e) => setName(e.target.value)} className='bg-grayColor outline-0 p-4 rounded-xl ' value={name} type="text" placeholder='Your Name' />
                    </div>
                    <div className='flex'>
                        <h2 className='text-[20px] leading-[30px] font-medium'>Starting Date</h2>
                        <h2 className='text-blue'>*</h2>
                    </div>
                    <div className='bg-grayColor rounded-xl'>
                        ...
                        <div className="col-sm-9">
                            <div className="input-group date">
                                ...
                                <input type="text" value="<?php if($result != '') echo date('m/d/Y', $result->purchasedate->sec);"
                                    name="purchasedate" id="purchasedate" className="form-control required" />
                            </div>
                        </div>
                    </div>
                    <div className='flex'>
                    ...
                    <div className='bg-grayColor rounded-xl'>
                        <input className='bg-grayColor outline-0 p-4 rounded-xl' type="text" placeholder='Amelia Watson' />
                    </div>
                    <div className='flex'>
                        <h2 className='text-[20px] leading-[30px] font-medium'>Extra Facilities</h2>
                        <h2 className='text-blue'>*</h2>
                    </div>
                    <div className='bg-grayColor rounded-xl'>
                        <input className='bg-grayColor outline-0 p-4 rounded-xl' type="text" placeholder='Amelia Watson' />
