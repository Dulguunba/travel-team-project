...
import { Left, LocationWhite, Right, Select } from '../icons/destination'
                        ...
                        <div className='md:flex gap-[30px]'>
                            <div className='w-full'>
                                <div className='flex pb-4'>
                                    ...
                                    {formik.touched.firstName && formik.errors.firstName ? (<div className='lg:pl-5'>{formik.errors.firstName}</div>) : null}
                                </div>
                        ...
                        <div className='md:flex gap-[30px] pt-12'>
                            <div className='w-full'>
                                <div className='flex pb-4'>
                                    ...
                                    <p className='text-blue'>*</p>
                                    {formik.touched.email && formik.errors.email ? (<div className='pl-5'>{formik.errors.email}</div>) : null}
                                </div>
                                <div className='lg:max-w-[745px] w-full  flex items-center rounded-[15px] bg-grayColor h-[100px]'>  <input id="email" type="email" {...formik.getFieldProps('email')} className='bg-grayColor rounded-[15px] pl-12 w-full h-full' placeholder='AmeliaWatson@gmail.com' /></div>
                            ...
                            <div className='w-full'>
                                <div className='flex pb-4'>
                                    ...
                                    <p className='text-blue'>*</p>
                                    {formik.touched.phoneNumber && formik.errors.phoneNumber ? (<div className='pl-5'>{formik.errors.phoneNumber}</div>) : null}
                                </div>
                                <div className='lg:max-w-[745px] w-full  flex items-center rounded-[15px] bg-grayColor h-[100px]'>  <input id="phoneNumber" type="phoneNumber" {...formik.getFieldProps('phoneNumber')} className='bg-grayColor rounded-[15px] pl-12 w-full h-full' placeholder='123 - 456 - 7890' /></div>
