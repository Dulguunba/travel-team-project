...
import { SmileSvg, MountainSvg, FlagSvg, TimeSvg } from '../icons/HomeIcons/valueIcons'
        ...
        <div className='flex items-center justify-center bg-grayColor pt-20'>
            <div className='max-w-[1520px] w-[90%] flex flex-col gap-5 justify-center items-center mb-20'>
                <div className='text-center'>
                    <p className='text-blue lg:text-xl'>VALUES</p>
                    <h1 className='lg:text-[100px] lg:mt-10 text-3xl font-oswald font-bold'>OUR VALUES</h1>
                </div>
