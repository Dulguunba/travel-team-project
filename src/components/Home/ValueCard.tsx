...
export const ValueCard = ({ svg, title, description }: Props) => {
    ...
    return (
        <div className='w-[264px] h-[230px] flex flex-col justify-center items-center cursor-pointer rounded-3xl hover:bg-blue hover:text-white hover:scale-125 hover:-translate-y-10 transition ease-out duration-300 hover:p-5'>
            {svg}
