...
export const ValueCard = ({ svg, title, description }: Props) => {
    return (
        <div className='lg:w-[264px] lg:h-[230px] flex flex-col justify-center items-center cursor-pointer rounded-3xl lg:hover:bg-blue lg:hover:text-white lg:hover:scale-125 lg:hover:-translate-y-10 transition ease-out duration-300 lg:hover:p-5'>
            {svg}
